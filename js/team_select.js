$(document).ready(function () {
	...
	$("#week_select").change(function () {
		...
		window.location = window.location.origin + '/dash.php?week=' + this.value + '&season=' + $season;
	});
	$("#season_select").change(function () {
		$week = $("#week_select").find(":selected").val();
		window.location = window.location.origin + '/dash.php?week=' + $week + '&season=' + this.value;
	});
	$("#leaderboard_select").change(function () {
		$week = $("#leaderboard_select").find(":selected").val();
		window.location = window.location.origin + '/leaderboard.php?season=' + this.value;
	});
